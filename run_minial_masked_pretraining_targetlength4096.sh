...
run_experiment() {
  ...
  if [[ "$region" == "ALL" ]]; then
    output_dir="/data1st2/zhangyr/data/mmllm/pretraining/target_length_4096"
  else
    output_dir="/data1st2/zhangyr/data/mmllm/pretraining/target_length_4096/${region}_${condition}"
  fi
