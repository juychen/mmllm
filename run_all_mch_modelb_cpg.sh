...
run_experiment() {
  ...
  python run_m5c_query_sequence_atac_crosshyena_experiments.py \
    ...
    --m5c-bedgraph "/data2st1/junyi/output/llm0401/processed_meth/${condition}_${region}.C.m.bedGraph.gz" \
    --hm5c-bedgraph "/data2st1/junyi/output/llm0401/processed_meth/${condition}_${region}.C.h.bedGraph.gz" \
