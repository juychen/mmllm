...
#   --prediction-signal-h5ad ${output_dir}/${current_time}_norc_atac_to_5hmc_{sample_size}.csv \
...
python run_multimodal_track_experiments.py \
  ...
  --prediction-signal-h5ad ${output_dir}/${current_time}_rc_atac_to_5hmc_{sample_size}.csv \
