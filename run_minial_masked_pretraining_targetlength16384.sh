...
run_experiment() {
  ...
  if [[ "$region" == "ALL" ]]; then
    output_dir="/data1st2/zhangyr/data/mmllm/pretraining/target_length_16384"
  else
    output_dir="/data1st2/zhangyr/data/mmllm/pretraining/target_length_16384/${region}_${condition}"
  fi
