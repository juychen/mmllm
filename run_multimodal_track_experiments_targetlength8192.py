...
def parse_args():
    ...
    parser.add_argument("--output-csv", default="/data1st2/zhangyr/data/mmllm/test_results/target_length_8192/multimodal_track_results.csv")
    parser.add_argument("--output-json", default="/data1st2/zhangyr/data/mmllm/test_results/target_length_8192/multimodal_track_results.json")
    parser.add_argument("--timestamp", default="", help="Optional timestamp string for output path templates.")
    parser.add_argument(
        "--prediction-signal-csv",
        default="/data1st2/zhangyr/data/mmllm/test_results/target_length_8192/{timestamp}_{input_modality}_to_{target_modality}_{sample_size}.csv",
        help="Per-sample-size CSV export path template.",
    )
    parser.add_argument(
        "--regression-plot-path",
        default="/data1st2/zhangyr/data/mmllm/test_results/target_length_8192/{timestamp}_{input_modality}_to_{target_modality}_{sample_size}.png",
        help="Per-sample-size regression plot output path template.",
    )
    parser.add_argument(
        "--best-checkpoint-path",
        default="/data1st2/zhangyr/data/mmllm/test_results/target_length_8192/{timestamp}_{input_modality}_to_{target_modality}_best_{sample_size}.pt",
        help="Per-sample-size checkpoint path template for the best validation epoch.",
    )
    parser.add_argument(
        "--last-checkpoint-path",
        default="/data1st2/zhangyr/data/mmllm/test_results/target_length_8192/{timestamp}_{input_modality}_to_{target_modality}_last_{sample_size}.pt",
